...
import { CommonPropsType } from "./common.types";

export const BackgroundWrapper = styled.div<CommonPropsType>`
  display: flex;
...
export const QuestionLinkWrapper = styled.div<CommonPropsType>`
  margin-left: 96px;
...
export const InputErrorText = styled.div<CommonPropsType>`
  position: absolute;
  font-family: "Poppins", sans-serif;
  font-style: normal;
  font-weight: normal;
...
export const ShowPasswordIcon = styled.span<CommonPropsType>`
  width: 24px;
  height: 24px;
  background: ${(props) =>
    props.isShow
